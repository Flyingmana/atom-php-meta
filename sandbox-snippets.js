...
var phpGrammar = atom.grammars.grammarForScopeName('text.html.php');
var phpMetaTokens = phpGrammar.tokenizeLines(atom.workspace.getActiveTextEditor().getText());
...
for (var line in phpMetaTokens) {
  for (var token in phpMetaTokens[line]) {
    metaProcessor.processToken(phpMetaTokens[line][token]);
  }
}
